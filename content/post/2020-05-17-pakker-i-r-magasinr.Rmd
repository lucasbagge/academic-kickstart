...
det letter for mig selv, men også mine kollegaer at skrive koden.
...
og selve funktionen. Denne funktion går det let forbrugeren at skabe forbindelse
...
Det er altså let og meget gennemskueligt for brugeren, når en funktion skal burge.
...
Uanset i hvilken position man sidder er det altid nødvendig at lave grafer over
sit data. Det kan ofte være rigtig tidskrævende uasnet om man bruge excel, r eller
python. Derfor er det en god ide at lave en graf funktion, som har alle de ønskede funktionaliteter
der er behov for. Hermed mener jeg at man sørger for den kan plotte linjer, facet,
liggende, aggeringer osv.

Det er noget jeg har arbejdet på med at lave en følgene funktion der gør
livet så meget letter:
...
Her kan man igen læse en god beskrivelse af hvad funktionen gør.

Men her kan man tage sit data og lave nogle hurtige plots, med meget får kode,
